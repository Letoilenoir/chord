...
def save_and_exit():
    ...
    if choice == "yes":
        try:
            subprocess.run([r"C:\Program Files\MuseScore 4\bin\MuseScore4.exe", file_name], check=True)
        except FileNotFoundError:
            messagebox.showerror("Error", "MuseScore 4 not found. Please check the installation path.")
